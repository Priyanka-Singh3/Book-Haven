...
function Navbar() {
  ...
  const navItems = (
    <>
      ...
      <li>
        <a href="/bookmark"><MdOutlineBookmarks className="text-xl" /></a>
      </li>
      {/* <li>
        <a>About</a>
      </li> */}
    ...
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-white dark:text-black fixed top-0 left-0 right-0 z-50 ${sticky
            ? "sticky-navbar shadow-md bg-base-300 dark:bg-slate-100 dark:text-black durarion-200 transition-all ease-in-out "
            : ""
          }`}
      >
        <div className="navbar">
          <div className="navbar-start">
            ...
            <a className="font-bold md:text-2xl cursor-pointer">Book Haven</a>
          </div>
          <div className="navbar-end space-x-3">
...

            {
              authUser ? <Logout /> : <div className="">
                <a className="bg-black text-white px-3 py-2 cursor-pointer hover:bg-slate-800 duration-300 rounded-md" onClick={() => document.getElementById("my_modal_3").showModal()}>
                  Login
                </a>
                <Login />
              </div>
